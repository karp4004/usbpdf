...
Maven:
https://jitpack.io/?utm_source=chatgpt.com#karp4004/usbpdf
...
* [Create](https://docs.gitlab.com/user/project/repository/web_editor/#create-a-file)
  or [upload](https://docs.gitlab.com/user/project/repository/web_editor/#upload-a-file) files
* [Add files using the command line](https://docs.gitlab.com/topics/git/add_files/#add-files-to-a-git-repository)
  or push an existing Git repository with the following command:

```
cd existing_repo
git remote add origin https://gitlab.com/Krpov/mypdf.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/Krpov/mypdf/-/settings/integrations)
